...
<body class="min-h-screen flex transition-colors duration-200">
    ...
    {{-- Left panel: form --}}
    <div class="w-full lg:w-5/12 flex items-center justify-center px-8 py-12 bg-white dark:bg-gray-900 transition-colors duration-200">
        <div class="w-full max-w-md">
            ...
            <h1 class="text-4xl font-bold text-gray-800 dark:text-white mb-2">Log in.</h1>
            <p class="text-gray-500 dark:text-gray-400 mb-8">Log in dengan akun yang telah terdaftar.</p>

            <form id="loginCred" onsubmit="login(this)">
                <div class="mb-5">
                    <div class="relative">
                        ...
                        <input
                            ...
                            required
                            class="w-full pl-12 pr-4 py-3 text-base bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
                    </div>
                </div>
                ...
                <button
                    type="submit"
                    class="w-full py-3 px-6 text-base font-semibold text-white bg-blue-600 hover:bg-blue-700 rounded-lg shadow-md transition cursor-pointer">
                    Log in
                </button>
            </form>
        </div>
    ...
    <div class="hidden lg:flex lg:w-7/12 bg-gradient-to-br from-blue-600 to-cyan-500 dark:from-blue-800 dark:to-cyan-900 items-center justify-center transition-colors duration-200">
        <div class="text-center text-white px-12">
            ...
            <h2 class="text-3xl font-bold mb-3">Dashboard App</h2>
            <p class="text-blue-100 text-lg">Kelola bisnis Anda dengan lebih mudah dan efisien.</p>
        </div>
    </div>
    ...
    <script src="{{ asset('page-js/loginPage.js') }}?v={{ filemtime(public_path('page-js/loginPage.js')) }}"></script>
</body>
