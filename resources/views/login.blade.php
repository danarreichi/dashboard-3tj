        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <p class="auth-subtitle mb-5">Log in dengan akun yang telah terdaftar.</p>
                    <form id="loginCred" onsubmit="login(this)">
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" id="usernameField" name="username" class="form-control form-control-xl" placeholder="Username" required>
                            <div class="form-control-icon">
                                <i class="bi bi-person"></i>
                            </div>
                        </div>
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="password" id="passwordField" name="password" class="form-control form-control-xl" placeholder="Password" required>
                            <div class="form-control-icon">
