...
<body>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                ...
                                                <div class="filter-container col-12">
                                                    <select id="filterTrashed" class="form-select">
                                                        <option value="">Inventory aktif</option>
                                                        <option value="only">Inventory non-aktif</option>
                                            ...
                                            <div class="col-auto ms-auto align-self-end" id="addInventoryBtn" style="display: none;">
                                                <button data-bs-toggle="modal" data-bs-target="#primary"
                                                    ...
                                                    <span class="me-2"><i class="bi bi-person-plus-fill"></i></span>Tambah inventory
                                                </button>
                                            </div>
                                        </div>
    ...
    <script src="{{ asset('page-js-min/inventory.js') }}"></script>
</body>
