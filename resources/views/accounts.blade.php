...
<head>
    ...
    <title>Accounts - Mazer Admin Dashboard</title>
...
<body>
        ...
        <div id="main">
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <div class="filter-container col-12">
                                                    <select id="filterTrashed" class="form-select">
                                                        <option value="">Account aktif</option>
                                                        <option value="only">Account non-aktif</option>
                                                        <option value="with">Semua</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-auto ms-auto align-self-end" id="addAccountBtn"
                                                style="display: none;">
                                                <button data-bs-toggle="modal" data-bs-target="#primary"
                                                    class="btn btn-primary w-100 d-flex justify-content-center align-items-center">
                                                    <span class="me-2"><i
                                                            class="bi bi-person-plus-fill"></i></span>Tambah account
                                                </button>
                                            </div>
                                        </div>
            ...
            <footer>
                <div class="footer clearfix mb-0 text-muted">
                    ...
                    <div class="float-end">
                        <p>Crafted by Danar @ 2024</p>
                    </div>
                </div>
            </footer>
            <x-add-account-modal></x-add-account-modal>
            <x-edit-account-modal></x-edit-account-modal>
            <x-account-histories-modal></x-account-histories-modal>
        </div>
    </div>
    ...
    <script src="{{ asset('page-js/accounts.js') }}?v={{ filemtime(public_path('page-js/accounts.js')) }}"></script>
</body>
